        ...
        <main style={S.main}>
          ...
          <Section title="ประมาณการต้นทุน (Cost / Q)" open={sec.cost} onToggle={()=>toggle('cost')} accent>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(120px,1fr))',gap:8,marginBottom:14}}>
              <CostKPI label="ต้นทุนน้ำขาเข้า" value={fmtB(costCalc.rawCostPerM3Prod)} unit="฿/m³" color={O.cyan}/>
              <CostKPI label="น้ำผสม Reject" value={fmtB(costCalc.dilutionCostPerM3Prod)} unit="฿/m³" color={O.text3}/>
              <CostKPI label="ค่าไฟฟ้า" value={fmtB(costCalc.elecPerM3Prod)} unit="฿/m³" color={O.accent}/>
              <CostKPI label="ค่าเคมี" value={fmtB(costCalc.chemPerM3Prod)} unit="฿/m³" color={O.text2}/>
              <CostKPI label="ค่าดำเนินการ" value={fmtB(costCalc.opsPerM3Prod)} unit="฿/m³" color={O.gold}/>
            ...
            <Section title="2. ค่าเคมี (Chemical)" open={sec.costChem} onToggle={()=>toggle('costChem')}>
            ...
            {/* 2. Operation */}
            <Section title="3. ค่าดำเนินการ (Operation)" open={sec.costOps} onToggle={()=>toggle('costOps')}>
